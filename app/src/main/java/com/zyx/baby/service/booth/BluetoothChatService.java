...
public class BluetoothChatService {
    ...
    public BlockingQueue<Byte> getReceiveBuffer() {
...
//如果没有在输入流中没有数据，将会阻塞线程
                    InputStreamReader inputStreamReader =new InputStreamReader(mmInStream);//提高效率，将自己字节流转为字符流
                    BufferedReader bufferedReader=new BufferedReader(inputStreamReader);//加入缓冲区
                    String temp=null;
                    String info="";
                    while((temp=bufferedReader.readLine())!=null){
//                        info+=temp;
                        mHandler.obtainMessage(BluetoothChat.MESSAGE_READ, temp)
                                .sendToTarget();
                   }
                    }
                 catch (IOException e) {
