...
public class NotificationUtil {
    ...
    public static void showNotification(Context context) {
        Notification notification = new NotificationCompat.Builder(context)
                ...
                .setContentIntent(PendingIntent.getActivity(context, 1, new Intent(context, IndexActivity.class), PendingIntent.FLAG_CANCEL_CURRENT))
                .build();
    ...
    public static void showFullScreen(Context context) {
        ...
        hangIntent.setClass(context, IndexActivity.class);
    ...
    public static void shwoNotify(Context context) {
        ...
        mBuilder.setContent(view_custom)
                .setContentIntent(PendingIntent.getActivity(context, 4, new Intent(context, IndexActivity.class), PendingIntent.FLAG_CANCEL_CURRENT))
     ...
     * @param context
     */
    public static Notification shwoServiceNotify(Context context) {
        //先设定RemoteViews
        RemoteViews view_custom = new RemoteViews(context.getPackageName(), R.layout.view_custom);
        //设置对应IMAGEVIEW的ID的资源图片
        view_custom.setImageViewResource(R.id.custom_icon, R.drawable.logo);
