...
public class CloudEditText extends EditText {
    ...
    private void init() {
        ...
        drawablePadding = MyUtils.getInstance().dip2px(getContext(), 10);
        itemPadding = MyUtils.getInstance().dip2px(getContext(), 3);
...
//            int spansStringLength = getSpansStringLength(spans);
    ...
    private void generateOneSpan(Spannable spannableString, UnSpanText unSpanText) {
        ...
        BitmapDrawable bitmpaDrawable = (BitmapDrawable) MyUtils.getInstance().convertViewToDrawable(spanView);
...
//            System.out.println("start:"+start+";end:"+end);
    ...
    private BitmapDrawable drawImageSpan(int measuredWidth, String spanText) {
        ...
        textPaint.setTextSize(MyUtils.getInstance().dip2px(getContext(), (int) getTextSize()));
        textPaint.getTextBounds(spanText, 0, spanText.length(), textRect);
        int textPadding = MyUtils.getInstance().dip2px(getContext(),6);
        ...
        Drawable background = getResources().getDrawable(R.drawable.cloud_edit);
    ...
    public View getSpanView(Context context, String text, int maxWidth){
        ...
        view.setBackgroundResource(R.drawable.cloud_edit);
